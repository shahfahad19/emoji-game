...
function setItems() {
    ...
    var q2 = `<div>${getItem(0)}+${getItem(0)}+${getItem(1)}=<span class="item">${
        values[0] * 2 + values[1]
    }</span></div>`;

    var q3 = `<div>${getItem(0)}+${getItem(1)}-${getItem(2)}=<span class="item">${
        values[0] + values[1] - values[2]
    }</span></div>`;

    var q4 = `<div>${getItem(1)}+${getItem(2)}-${getItem(3)}=<span class="item">${
